        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-blue-100">
              ...
              support regarding AGILA, feel free to send us a message.
            </p>
          </div>
          ...
          >
            <div className="w-full max-w-4xl">
              <form className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-6 bg-blue-900 text-white rounded-md hover:bg-blue-700 transition cursor-pointer"
                >
                  Send Message
                </button>
              </form>
